...
int main() {
    ...
    for (i = 0; i < files.size(); i++) {
        ...
        FileWriter fileWriter = FileWriter(outputAddress.replace(outputAddress.find("_in"), sizeof("_in") - 1, "_out"), fileReader.getNLines());
        // Do this for each matrix in this file

        // Disable nesting to prevent threads to spread in functions
        omp_set_nested(0);
